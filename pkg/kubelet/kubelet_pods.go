...
func (kl *Kubelet) UserNamespaceForPod(pod *v1.Pod) (runtimeapi.NamespaceMode, error) {
	...
	case UsernsPod:
		...
		if !runtimeEnabled {
			return runtimeapi.NamespaceMode_NODE, fmt.Errorf("runtime doesn't supoprt user namespaces")
		}
		return runtimeapi.NamespaceMode_POD, nil
	case UsernsNode:
		return runtimeapi.NamespaceMode_NODE, nil
	default:
		return runtimeapi.NamespaceMode_NODE, fmt.Errorf("invalid value for the %q annotation", kivolkUsernsAnn)
	}
}
