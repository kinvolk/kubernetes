...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*v1beta1.LinuxIDMapping)(nil), (*config.LinuxIDMapping)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_LinuxIDMapping_To_config_LinuxIDMapping(a.(*v1beta1.LinuxIDMapping), b.(*config.LinuxIDMapping), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.LinuxIDMapping)(nil), (*v1beta1.LinuxIDMapping)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_LinuxIDMapping_To_v1beta1_LinuxIDMapping(a.(*config.LinuxIDMapping), b.(*v1beta1.LinuxIDMapping), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*v1beta1.LinuxIDMappings)(nil), (*config.LinuxIDMappings)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_LinuxIDMappings_To_config_LinuxIDMappings(a.(*v1beta1.LinuxIDMappings), b.(*config.LinuxIDMappings), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.LinuxIDMappings)(nil), (*v1beta1.LinuxIDMappings)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_LinuxIDMappings_To_v1beta1_LinuxIDMappings(a.(*config.LinuxIDMappings), b.(*v1beta1.LinuxIDMappings), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta1_KubeletConfiguration_To_config_KubeletConfiguration(in *v1beta1.KubeletConfiguration, out *config.KubeletConfiguration, s conversion.Scope) error {
	...
	if err := Convert_v1beta1_LinuxIDMappings_To_config_LinuxIDMappings(&in.ClusterIDMappings, &out.ClusterIDMappings, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_config_KubeletConfiguration_To_v1beta1_KubeletConfiguration(in *config.KubeletConfiguration, out *v1beta1.KubeletConfiguration, s conversion.Scope) error {
	...
	if err := Convert_config_LinuxIDMappings_To_v1beta1_LinuxIDMappings(&in.ClusterIDMappings, &out.ClusterIDMappings, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_v1beta1_LinuxIDMapping_To_config_LinuxIDMapping(in *v1beta1.LinuxIDMapping, out *config.LinuxIDMapping, s conversion.Scope) error {
...
// Convert_v1beta1_LinuxIDMapping_To_config_LinuxIDMapping is an autogenerated conversion function.
func Convert_v1beta1_LinuxIDMapping_To_config_LinuxIDMapping(in *v1beta1.LinuxIDMapping, out *config.LinuxIDMapping, s conversion.Scope) error {
	return autoConvert_v1beta1_LinuxIDMapping_To_config_LinuxIDMapping(in, out, s)
}

func autoConvert_config_LinuxIDMapping_To_v1beta1_LinuxIDMapping(in *config.LinuxIDMapping, out *v1beta1.LinuxIDMapping, s conversion.Scope) error {
	out.HostID = in.HostID
	out.ContainerID = in.ContainerID
	out.Size = in.Size
	return nil
...
// Convert_config_LinuxIDMapping_To_v1beta1_LinuxIDMapping is an autogenerated conversion function.
func Convert_config_LinuxIDMapping_To_v1beta1_LinuxIDMapping(in *config.LinuxIDMapping, out *v1beta1.LinuxIDMapping, s conversion.Scope) error {
	return autoConvert_config_LinuxIDMapping_To_v1beta1_LinuxIDMapping(in, out, s)
}

func autoConvert_v1beta1_LinuxIDMappings_To_config_LinuxIDMappings(in *v1beta1.LinuxIDMappings, out *config.LinuxIDMappings, s conversion.Scope) error {
	out.UIDMappings = *(*[]config.LinuxIDMapping)(unsafe.Pointer(&in.UIDMappings))
	out.GIDMappings = *(*[]config.LinuxIDMapping)(unsafe.Pointer(&in.GIDMappings))
	return nil
}

// Convert_v1beta1_LinuxIDMappings_To_config_LinuxIDMappings is an autogenerated conversion function.
func Convert_v1beta1_LinuxIDMappings_To_config_LinuxIDMappings(in *v1beta1.LinuxIDMappings, out *config.LinuxIDMappings, s conversion.Scope) error {
	return autoConvert_v1beta1_LinuxIDMappings_To_config_LinuxIDMappings(in, out, s)
}

func autoConvert_config_LinuxIDMappings_To_v1beta1_LinuxIDMappings(in *config.LinuxIDMappings, out *v1beta1.LinuxIDMappings, s conversion.Scope) error {
	out.UIDMappings = *(*[]v1beta1.LinuxIDMapping)(unsafe.Pointer(&in.UIDMappings))
	out.GIDMappings = *(*[]v1beta1.LinuxIDMapping)(unsafe.Pointer(&in.GIDMappings))
	return nil
}

// Convert_config_LinuxIDMappings_To_v1beta1_LinuxIDMappings is an autogenerated conversion function.
func Convert_config_LinuxIDMappings_To_v1beta1_LinuxIDMappings(in *config.LinuxIDMappings, out *v1beta1.LinuxIDMappings, s conversion.Scope) error {
	return autoConvert_config_LinuxIDMappings_To_v1beta1_LinuxIDMappings(in, out, s)
}
