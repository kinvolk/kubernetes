...
func (b *downwardAPIVolumeMounter) SetUpAt(dir string, mounterArgs volume.MounterArgs) error {
	...
	data, err := CollectData(b.source.Items, b.pod, b.plugin.host, b.source.DefaultMode, mounterArgs.FsUser)
	if err != nil {
...
func CollectData(items []v1.DownwardAPIVolumeFile, pod *v1.Pod, host volume.VolumeHost, defaultMode *int32, fsUser *int64) (map[string]volumeutil.FileProjection, error) {
	if defaultMode == nil {
